<?php
  ...
  $sql = "insert into booksale_board(product_name, writer,  publisher, book_status, category_name1, category_name2, school_name, professor_name, subject_name, class_year, semester, price_origin,
  ...
  values('$product_name', '$writer', '$publisher', '$book_status', '$category_name1', '$category_name2', '$school_name', '$professor_name', '$subject_name', '$class_year', '$semester', '$price_origin',
