    ...
    <div id="contents">
        ...
        <div id="promo_list">
            ...
            <!--<form name="promoBoardList" action="post">-->
                ...
                //$sql = "select * from promotion_board a LEFT JOIN member b ON a.member_id = b.userid order by a.num desc";
                $sql = "select a.num, a.member_id, b.username, a.promo_type, a.promo_subject, a.file_name, a.regist_day, a.hit from promotion_board a LEFT JOIN member b ON a.member_id = b.userid order by a.num desc";
                $result = mysqli_query($con, $sql);
                $total_record = mysqli_num_rows($result); // 전체 글 수

                $scale = 10; // 한 페이지당 보여줄 게시물 수
                ...
                <div class="tbl_top">
                    ...
                    <button type="button" onclick="location.href='board_form.php'" class="btn_small grey fr">글쓰기</button>
                </div>
            ...
            <form action="board_search.php" method="get">
                ...
                <div class="bottom_sch">
                    ...
                    <button type="submit" value="검색" class="btn_lsmall grey">검색</button>
